        ...
        return (
            <div className="container-xl">
                <article className="col-4">
                    <h3><b><u>Supplies:</u></b></h3>
                    <span><b>ID: </b>{MED[ID].id}</span>
                    <br />
                ...
                <section className="row">
                    ...
                    <article className="col-3">
                        <h4><u>Send by:</u></h4>
                        <p><b>ID: </b>{RET[MED[ID].RETid].id}</p>
