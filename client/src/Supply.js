...
function Supply() {
    ...
    return (
        <div className="supply-container">
            ...
            {/* <p>Order -&gt; Raw Material Supplier -&gt; Manufacturer -&gt; Distributor -&gt; Retailer -&gt; Consumer</p> */}
            <p>Order -&gt; Pickup the Supplies -&gt; Delieverd To Warehouse -&gt; Process The Order -&gt; Send To Restaurant -&gt; Recieved at Restaurant</p>
            ...
            <div className="supply-step">
                <h5><b>Step 1: Pickup the Supplies</b> {/*(Only a registered Raw Material Supplier can perform this step)*/}:</h5>
                <form onSubmit={handlerSubmitRMSsupply}>
                    <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter ID" required />
                    <button className="btn btn-outline-success btn-sm">Confirm</button>
                </form>
            </div>
            <hr />
            <div className="supply-step">
                <h5><b>Step 2: Delieverd To Warehouse</b> {/*(Only a registered Manufacturer can perform this step)*/}:</h5>
            ...
            <hr />
            <div className="supply-step">
                <h5><b>Step 3: Process The Order</b> {/*(Only a registered Distributor can perform this step)*/}:</h5>
            ...
            <hr />
            <div className="supply-step">
                <h5><b>Step 4: Send To Restaurant</b> {/*(Only a registered Retailer can perform this step)*/}:</h5>
            ...
            <hr />
            <div className="supply-step">
                <h5><b>Step 5: Recieved at Restaurant</b> {/*(Only a registered Retailer can perform this step)*/}:</h5>
